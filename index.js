...
// returnHomeGoals2014(fifaData);
// /* 
// (d) Away Team goals for 2014 [world cup final
// */
// function returnAwayGoals2014(array){
//     for (let i = 0; i < array.length; i++){
//         if (fifaData[i].Year === 2014){
//             console.log(`Away: ${fifaData[i]["Away Team Name"]}, Goals: ${fifaData[i]["Away Team Goals"]}`);
//         }
//     }
    
// };

// returnAwayGoals2014(fifaData);
// /*
...
function getCountryWins(data/*, teamInitials*/) {
    ...
    // const winTotalSum = winTotal.reduce((item) => {
    //     return item;
    // });
    return winTotal//, winTotalSum;
}
